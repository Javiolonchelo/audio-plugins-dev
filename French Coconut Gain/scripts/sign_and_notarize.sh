...
if [ $# -lt 5 ]; then
    ...
    echo ""
    echo "Usage: $0 <BUILD_CONFIG> <BUNDLE_ID> <PLUGIN_NAME> <VERSION> <PROJECT_NAME> [LICENSE_FILE]"
    echo ""
    echo "Example:"
    echo "  $0 Release com.dBobStudio.FrenchCoconutGain \"French Coconut Gain\" 1.0.0 French_Coconut_Gain /path/to/LICENSE"
    echo ""
    exit 1
fi
